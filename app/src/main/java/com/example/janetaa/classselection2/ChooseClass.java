...
public class ChooseClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //when the correct button is click the error will clear
    ...
    //function to change the color of the radio button if the radio button its check
    ...
    //function to display  an error if the classes are at the same time of the day
